...
if(isset($_POST['delete_profile'])){//cannot use"()" ($_GET as we want to get the logout btn.)
    $delete=mysqli_query($con,"DELETE FROM chat2 WHERE Id='$user_id' ")or die('query failed');
        unset($_SESSION);
...
if(isset($_POST['update_profile'])){
    ...
    mysqli_query($con,"UPDATE chat2 SET fname='$update_name',email='$update_email' WHERE Id='$user_id' ")or die('query failed');
    ...
    if(($update_pass!=$old_pass)){
        ...
        mysqli_query($con,"UPDATE chat2 SET password='$confirm_pass' WHERE Id='$user_id' ")
    or die('query failed');
...
<?php
$select=mysqli_query($con,"SELECT * FROM chat2 WHERE Id = '$user_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class=flex>
   <div class=inputBox>
    ...
    <a href="login.php" class="delete-btn">Back</a>
